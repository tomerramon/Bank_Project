 ...
 */
export async function generateOTP(userId, type, expirationMinutes = 10) {
    // Generate OTP code
 ...
 */
export async function canRequestOTP(userId, type) {
 ...
 */
export async function getValidOTP(userId, type) {
